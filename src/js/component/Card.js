    ...
    <div className="card m-1 col-xl-2 col-lg-3 col-md-4 col-sm-6 justify-content-center px-0 border-0  card-principal">
      ...
      <div className="card-body">
        ...
        <div className="d-flex justify-content-between">
          {props.route === "people" ? (
            <Link to={"/character/" + props.id} className="btn btn-warning">
              Más info
            </Link>
          ) : props.route === "vehicle" ? (
            <Link to={"/vehicle/" + props.id} className="btn btn-warning">
              Más info
            </Link>
          ) : props.route === "planet" ? (
            <Link to={"/planet/" + props.id} className="btn btn-warning">
              Más info
            </Link>
          ) : null}
          <button
